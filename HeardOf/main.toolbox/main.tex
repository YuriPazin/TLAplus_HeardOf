...
\fl{}\moduleLeftDash\cl{ {\MODULE} main}\moduleRightDash\cl{}
\fl{}
\fl{ {\LOCAL} {\INSTANCE} Integers}
\fl{ {\LOCAL} {\INSTANCE} FiniteSets}
\fl{ {\LOCAL} {\INSTANCE} Sequences}
\fl{ {\LOCAL} {\INSTANCE} ExtendedSequences}
\fl{ {\LOCAL} {\INSTANCE} TLC}
\fl{}
\fl{}
\fl{ {\CONSTANTS} n}
\fl{}
\fl{}
\fl{}
 \fl{ SpecInit}\al{13}{1}{ \.{\defeq}}\al{13}{2}{ P}\al{13}{3}{
 \.{=}}\al{13}{4}{ ( 1 \.{\dotdot} n )}
\fl{}
 \fl{ SpecNext}\al{15}{1}{ \.{\defeq}}\al{15}{2}{ P}\al{15}{3}{
 \.{=}}\al{15}{4}{ ( 1 \.{\dotdot} n )}
\fl{}
\fl{}
\fl{}
...
\fl{ Invar \.{\defeq} {\TRUE}}
\fl{}
\fl{ ModelConstraint \.{\defeq} TLCGet (\@w{level} ) \.{<} 9}
\fl{}
\fl{}\bottombar\cl{}
\fl{}
\fl{}
